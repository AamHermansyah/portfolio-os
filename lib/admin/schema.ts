...
export const RESOURCES: ResourceSpec[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "skinColor", label: "Avatar skin", type: "string", max: 9, hint: "hex", fallback: "#e8b98f" },
      { name: "hairColor", label: "Avatar hair", type: "string", max: 9, hint: "hex", fallback: "#2f211b" },
      { name: "shirtColor", label: "Avatar shirt", type: "string", max: 9, hint: "hex", fallback: "#000080" },
